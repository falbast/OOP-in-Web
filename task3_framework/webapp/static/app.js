$(document).ready(function(){
  ...
  $("#create-button").on("click", function (e) {
    ...
    $.ajax({
        ...
        data: {"predict": predict, "seniority": seniority, "home": home, "time": time, "age": age, "marital": marital, "records": records, "job": job, "expenses": expenses, "income": income, "assets": assets, "debt": debt, "amount": amount, "price": price},
        statusCode: {
          401: function() {
